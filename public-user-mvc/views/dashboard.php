...
<title>Dashboard · EcoLotLK</title>
  ...
  <div class="content">
    <div class="header-row">
      ...
      <div class="header-controls">
        <a href="index.php?route=new-request" class="btn-primary">
    ...
    <div class="card">
      <div class="card-header-simple">
        ...
        <a href="index.php?route=my-requests" class="view-all">View All</a>
      </div>
      ...
      <table style="margin-bottom: 12px;">
        ...
        <tbody>
          ...
          <?php else: ?>
            ...
            ?>
              <tr>
                <td><a href="index.php?route=new-request&id=<?php echo htmlspecialchars($req['id']); ?>" class="view-link"><?php echo htmlspecialchars($req['id']); ?></a></td>
      ...
      <div class="table-footer">
        <a href="index.php?route=my-requests" class="view-more-link">
          View More Requests 
