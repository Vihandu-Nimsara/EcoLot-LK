...
<div class="collector-section-header"><div><span>Schedule #<?= $escape($schedule['schedule_id']) ?></span><h2><?= $escape($schedule['area_name']) ?></h2></div><span class="collector-count-pill"><?= $escape(CollectionRecord::label($schedule['schedule_status'])) ?></span></div>
