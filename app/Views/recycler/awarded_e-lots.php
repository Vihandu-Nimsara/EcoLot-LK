...
<div class="awarded-e-lot-header"><div><h2>My Awarded E-Lots</h2><p>Your winning bids, selected by the Municipal Officer.</p></div></div>
...
<td data-label="Lot Status"><?= $escape(str_replace('_', ' ', $lot['lot_status'])) ?></td><td data-label="Handover"><?= $escape($lot['handover_status'] ?? 'Not recorded') ?></td>
