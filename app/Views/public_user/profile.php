  ...
  <div class="profile-grid">
    <div class="col">
      <div class="card">
        ...
        <div class="grid-2">
          <div class="field"><label>First Name</label><input type="text" value="Pawani" readonly></div>
          <div class="field"><label>Last Name</label><input type="text" value="Perera" readonly></div>
        </div>
      </div>
    ...
    <div class="col">
      <div class="card">
        ...
        <div class="field"><label>Email</label><input type="email" value="pawani@example.com" readonly></div>
        <div class="field"><label>Phone</label><input type="tel" value="071 234 5678" readonly></div>
        <div class="field"><label>Address</label><textarea rows="3" readonly>No. 45, Galle Road, Colombo 06</textarea></div>
        <p class="locked-note">
