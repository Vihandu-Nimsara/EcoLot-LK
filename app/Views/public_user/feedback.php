<p class="breadcrumb"><a href="/EcoLot-LK/public/user/dashboard">Dashboard</a> &nbsp;›&nbsp; Complaint / Feedback</p>
<h1 class="title">Complaint / Feedback</h1>
<p class="subtitle">We value your feedback and are here to help.</p>

<div class="layout-2">
  <form class="card" method="POST" action="/EcoLot-LK/public/user/feedback-submit">
    <div class="field">
    ...
    <div style="display:flex;justify-content:flex-end;gap:12px;">
      <a href="/EcoLot-LK/public/user/dashboard" class="btn" style="text-decoration:none; display:inline-flex; align-items:center; justify-content:center;">Cancel</a>
...
<script src="/EcoLot-LK/public/assets/js/public_user/feedback.js"></script>
