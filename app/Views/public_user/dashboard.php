<div class="header-row">
  <div>
    ...
    <h1 class="title">Welcome Back, <?php echo htmlspecialchars($user['first_name']); ?>!</h1>
    <p class="subtitle">Monitor your disposal milestones and upcoming recycling collections.</p>
  </div>
  
  <div class="header-controls">
    <a href="/EcoLot-LK/public/user/new-request" class="btn-primary">
    ...
    <div style="position: relative;">
      ...
      <div class="noti-dropdown" id="notiDropdown">
        ...
        <?php if (isset($_GET['feedback_success'])): ?>
          <div class="noti-item" style="border-left: 3px solid #1b7a4a; background: #f0f7f4;">
            <p><strong>Feedback Submitted!</strong> Thank you for your feedback.</p>
            <span>Just now</span>
          </div>
        <?php endif; ?>
        <div class="noti-item">
          <p>Your request <strong>REQ-2024-00011</strong> has been completed.</p>
...
<div class="stats-grid">
  ...
  <div class="stat-card">
    ...
    <div class="stat-info">
      <span class="stat-value"><?php echo number_format($stats['weight'], 1); ?> kg</span>
...
<div class="card">
  <div class="card-header-simple">
    ...
    <a href="/EcoLot-LK/public/user/my-requests" class="view-all">View All</a>
  </div>
  ...
  <table style="margin-bottom: 12px;">
    ...
    <tbody>
      <?php if (empty($latestRequests)): ?>
        <tr>
          <td colspan="7" style="text-align: center; color: var(--muted); padding: 20px;">No pickup requests found. Click "New Pickup Request" to create one!</td>
        </tr>
      <?php else: ?>
        ...
        ?>
          <tr>
            <td><a href="/EcoLot-LK/public/user/new-request?id=<?php echo htmlspecialchars($req['id']); ?>" class="view-link"><?php echo htmlspecialchars($req['id']); ?></a></td>
  ...
  <div class="table-footer">
    <a href="/EcoLot-LK/public/user/my-requests" class="view-more-link">
      View More Requests 
...
<script src="/EcoLot-LK/public/assets/js/public_user/dashboard.js"></script>
