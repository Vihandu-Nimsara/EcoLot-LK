...
<div class="sidebar">
    <div>
        <div class="logo-container">
            <img src="/EcoLot-LK/public/assets/images/public_user/logo-header.png" alt="EcoLot LK Workspace" class="logo-header-img">
        </div>
        <a href="/EcoLot-LK/public/user/profile" class="nav-item <?php echo ($currentPage === 'profile') ? 'active' : ''; ?>">
        ...
        <a href="/EcoLot-LK/public/user/dashboard" class="nav-item <?php echo ($currentPage === 'dashboard') ? 'active' : ''; ?>">
        ...
        <a href="/EcoLot-LK/public/user/new-request" class="nav-item <?php echo ($currentPage === 'new-request') ? 'active' : ''; ?>">
        ...
        <a href="/EcoLot-LK/public/user/my-requests" class="nav-item <?php echo ($currentPage === 'my-requests') ? 'active' : ''; ?>">
        ...
        <a href="/EcoLot-LK/public/user/feedback" class="nav-item <?php echo ($currentPage === 'feedback') ? 'active' : ''; ?>">
