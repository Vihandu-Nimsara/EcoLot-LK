<p class="breadcrumb"><a href="/EcoLot-LK/public/user/dashboard">Dashboard</a> &nbsp;›&nbsp; <?php echo $isEdit ? 'Edit' : 'New'; ?> Pickup Request</p>
...
<form method="POST" action="/EcoLot-LK/public/user/new-request-submit">
  ...
  <div class="layout-grid">
    <div class="form-column">
      ...
      <div class="action-bar">
        <a href="/EcoLot-LK/public/user/my-requests" class="btn" style="text-decoration:none; display:inline-flex; align-items:center; justify-content:center;">Cancel</a>
...
<script src="/EcoLot-LK/public/assets/js/public_user/new-request.js"></script>
